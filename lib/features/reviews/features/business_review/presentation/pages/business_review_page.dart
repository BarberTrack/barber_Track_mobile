...
class _BusinessReviewPageState extends State<BusinessReviewPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          sl<BusinessReviewBloc>()
            ..add(LoadBusinessReviews(widget.businessId, status: 'approved')),
      child: Builder(
        builder: (context) {
          return Scaffold(
            ...
            body: BlocBuilder<BusinessReviewBloc, BusinessReviewState>(
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Este negocio no tiene reseñas aún.',
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                '${reviewResponse.totalReviews} reseña${reviewResponse.totalReviews != 1 ? 's' : ''}',
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final review = reviewResponse.reviews[index];
