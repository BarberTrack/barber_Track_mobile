...
class RepeatAppointmentRequest extends Equatable {
  final String appointmentId;
  final String scheduledDatetime;

  const RepeatAppointmentRequest({
    required this.appointmentId,
    required this.scheduledDatetime,
  });

  @override
  List<Object> get props => [appointmentId, scheduledDatetime];
}

class RepeatAppointmentResponse extends Equatable {
  final bool success;
  final String message;
  final RepeatAppointmentData data;

  const RepeatAppointmentResponse({
...
class RepeatAppointmentData extends Equatable {
  final RepeatedAppointment appointment;
  final bool created;
  final String confirmationCode;

  const RepeatAppointmentData({
...
class RepeatedAppointment extends Equatable {
  final String id;
