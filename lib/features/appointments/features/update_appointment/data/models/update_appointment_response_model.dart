...
class UpdateAppointmentResponseModel extends Equatable {
  final bool success;
  final String message;
  final UpdateAppointmentDataModel data;

  const UpdateAppointmentResponseModel({
    required this.success,
    required this.message,
    required this.data,
  });

  factory UpdateAppointmentResponseModel.fromJson(Map<String, dynamic> json) {
    return UpdateAppointmentResponseModel(
      success: json['success'] as bool,
      message: json['message'] as String,
      data: UpdateAppointmentDataModel.fromJson(
...
class UpdateAppointmentDataModel extends Equatable {
  final UpdatedAppointmentModel appointment;
  final bool updated;
  final Map<String, dynamic> changes;

  const UpdateAppointmentDataModel({
    required this.appointment,
    required this.updated,
    required this.changes,
  });

  factory UpdateAppointmentDataModel.fromJson(Map<String, dynamic> json) {
    return UpdateAppointmentDataModel(
      appointment: UpdatedAppointmentModel.fromJson(
...
class UpdatedAppointmentModel extends Equatable {
  final String id;
  ...
  factory UpdatedAppointmentModel.fromJson(Map<String, dynamic> json) {
    return UpdatedAppointmentModel(
      ...
      statusHistory: (json['statusHistory'] as List<dynamic>)
          .map(
            (history) =>
                StatusHistoryModel.fromJson(history as Map<String, dynamic>),
          )
          .toList(),
